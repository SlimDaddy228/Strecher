...
attachPropList = {
	{["model"] = 'xm_prop_x17_bag_med_01a',				["name"] = "MedBag", 		["bone"] = 28422, ["x"] = 0.4,	["y"] = -0.1,	["z"] = -0.1,	["xR"] = 315.0,	["yR"] = 298.0, ["zR"] = 0.0, 	["anim"] = 'pick' },
}
...
RegisterNetEvent("deletek")
AddEventHandler("deletek", function()
		removeall()
	end, false)
